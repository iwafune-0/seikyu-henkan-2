...
- P-003 処理履歴・ダウンロードページ: **12/14項目** (4項目スキップ - テストデータ条件不足)
...
- [-] E2E-HIST-005: E2E-P003-005 処理者フィルター（※処理者1人のみでスキップ）
...
- [-] E2E-HIST-011: E2E-P003-011 個別ファイルダウンロード（※モーダル内ダウンロードボタン未検出でスキップ）
- [x] E2E-HIST-012: E2E-P003-012 ZIP一括ダウンロード
- [-] E2E-HIST-013: E2E-P003-013 削除済みユーザーのグレー表示（※削除済みユーザーなしでスキップ）
- [-] E2E-HIST-014: E2E-P003-014 無効な取引先のグレー表示（※無効な取引先なしでスキップ）
...
- [-] E2E-USER-009: TC-102 最終管理者の降格拒否（※UIでは到達不可能なシナリオのため対象外）
