...
期待結果:
  - Snackbarで「ロールを変更しました: {email} (一般ユーザー → 管理者)」と表示される
  - ロール列が「管理者」に更新される
```
...
期待結果:
  - Snackbarで「ロールを変更しました: {email} (管理者 → 一般ユーザー)」と表示される
  - ロール列が「一般ユーザー」に更新される
```
...
期待結果:
  - Snackbarで「ユーザーを削除しました: {email}」と表示される
  - ユーザー一覧から該当ユーザーが消える
```
...
期待結果:
  - ダイアログで「最終管理者のため削除できません。他のユーザーを管理者に昇格してから削除してください。」と表示される
  - 削除は実行されない
```
...
期待結果:
  - ダイアログで「最終管理者のため降格できません。他のユーザーを管理者に昇格してから変更してください。」と表示される
  - ロールは変更されない
```
